  ...
  <form:form method="POST" action="">  
      <table>  
       <tr>  
           ...
           <td><form:input path="pid" value="" readonly="true"/></td>  
       </tr>  
       <tr>  
           <td><form:label path="type">Publication Title:</form:label></td>  
           <td><form:input path="type" value="${publication.pubTitle}"/></td>  
       </tr>  
